...
public class FmtParser {
	...
	private long parserPtr; // stores the fmt-parser pointer, managed by C, see native source code.
	private FmtParser(long parserPtr) { this.parserPtr = parserPtr; }
	
	/** Create a new FmtParser. Set isServer to true is you are run at server side. The arg isFull is not used currently. */
